...
function MediaCard({ img }) {
    ...
    return (
        <div className='w-48'>
            <div className='relative h-72 w-full bg-center bg-cover rounded-tl-xl rounded-tr-xl' style={{ backgroundImage: `url(/images/${img}.jpg)` }}>
            ...
            <div className='*:line-clamp-1 *:text-sm dark:text-white text-center space-y-2'>
